                    ...
                    <matrixSize>
                        ...
                        <xsl:choose>
                            <xsl:when test="siemens/MEAS/sKSpace/ucTrajectory = 1">
                                <x>
                                    <xsl:value-of select="floor(siemens/YAPS/iNoOfFourierColumns div 2)"/> <!-- SNS modified -->
                                    <!-- <xsl:value-of select="siemens/YAPS/iNoOfFourierColumns"/> -->
                                    <!-- <xsl:value-of select="siemens/IRIS/DERIVED/imageColumns"/> --> <!-- SNS modified -->
                                </x>
                            </xsl:when>
                            <xsl:otherwise>
                                <x>
                        ...
                        <xsl:choose>
                            <xsl:when test="siemens/MEAS/sKSpace/ucTrajectory = 1">
                                <x>
                                    ...
                                    <xsl:value-of select="siemens/MEAS/sSliceArray/asSlice/s0/dReadoutFOV"/> <!-- SNS modified -->
